...
void setup() {
  ...
  Serial.println("\n🔍 Possible issues:");
  Serial.println("   1. Your ILI9341 module doesn't have SD slot");
  Serial.println("   2. SD card not inserted in display module");
  Serial.println("   3. SD_CS pin is different (check module label)");
  Serial.println("   4. Need to connect SD_CS wire to ESP32");
  Serial.println("\n💡 Check the back of your display for:");
  Serial.println("   - MicroSD card slot");
  Serial.println("   - Pin labeled SD_CS, SDCS, or CS_SD");
}
